...
public class ReflectionHelper {
    ...
    public static List<Method> getMethodsWithAnnotation(final Class<?> type, final Class<? extends Annotation> annotation) {
        final List<Method> methods = new ArrayList<>();
            final List<Method> allMethods = new ArrayList<>(Arrays.asList(type.getMethods()));
